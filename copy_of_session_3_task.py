# -*- coding: utf-8 -*-
"""Copy of session-3-task.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1f_UJwHO1t8F67U1xgTMN_TRYghAJDijd
...
for i in range(1,n+1):
  sum+=0.5*(((x-1)/x)**a)
  a+=1
print('Sum of first seven terms is:',sum)
...
A = input("Enter the first sentence: ").lower().split()
B = input("Enter the second sentence: ").lower().split()
...
finder = input("Enter the word to be find: ")
...
for i in word_list:
  if i == finder:
    print('Location of the word is', count)
    break
  else:
    count+=1
